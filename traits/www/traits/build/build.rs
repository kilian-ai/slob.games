    ...
    let markup = html! {
        ...
        html lang="en" {
            head {
                ...
                title { "slob.games \u{2014} AI-powered game canvas" }
            ...
            body {
                ...
                div.hero {
                    ...
                    h1 { span { "slob" } ".games" }
                    p.sub { "AI-powered game canvas. Ask your voice agent to build and modify games in real time. Powered by the traits.build kernel — composable Rust functions compiled to a single binary and WASM." }
                    div.cta {
                        ...
                        a.btn.btn-outline href="https://github.com/kilian-ai/slob.games" { "GitHub" }
                    }
                }
...
const TRAITS: &[(&str, &str)] = &[
    ...
    ("www.slob.games", "This landing page \u{2014} stats pulled live from registry"),
...
<span class="kw">$</span> curl -X POST https://slob.games/traits/sys/checksum \
    -H <span class="s">'Content-Type: application/json'</span> \
    -d <span class="s">'{"args": ["hash", "hello"]}'</span>

<span class="cm"># List everything</span>
<span class="kw">$</span> curl https://slob.games/traits/sys/list

<span class="cm"># Health check</span>
<span class="kw">$</span> curl https://slob.games/health</pre>"##;
